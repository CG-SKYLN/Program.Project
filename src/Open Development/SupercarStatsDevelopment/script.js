...
class SaveFeedback {
  ...
  saveFile() {
    ...
    const name = formhandler.php.getElementById('name');
    const suggestion = formhandler.php.getElementById('suggest');
    ...
    const sFileName = 'feedback.txt';	   // The file to save the data.
